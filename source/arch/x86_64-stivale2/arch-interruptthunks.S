...
.if \num != 8 && \num != 10 && \num != 11 && \num != 12 && \num != 13 && \num != 14 && \num != 17 && \num != 30
    push $0
.endif
    # Check for the user 64 bit code selector in CS.
    cmpq $0x43, 16(%rsp)
    jne 1f
    swapgs
1:
    ...
    # XXX: Second part of above's XXX.
    pop %rax
    mov %eax, %ds
    pop %rax
    mov %eax, %es
