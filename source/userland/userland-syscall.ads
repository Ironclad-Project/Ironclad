...
package Userland.Syscall is
   ...
   type Stat is record
      ...
      Change_Time   : Time_Spec;
      Birth_Time    : Time_Spec;
   ...
   for Stat use record
      ...
      Change_Time   at 0 range 640 ..  767;
      Birth_Time    at 0 range 768 ..  895;
      Block_Size    at 0 range 896 ..  959;
      Block_Count   at 0 range 960 .. 1023;
   end record;
   for Stat'Size use 1024;
   procedure FStat
      (Dir_FD    : Unsigned_64;
       Path_Addr : Unsigned_64;
       Path_Len  : Unsigned_64;
   ...
   MAC_CAP_SCHED     : constant := 2#00000000000000001#;
   MAC_CAP_SPAWN     : constant := 2#00000000000000010#;
   MAC_CAP_ENTROPY   : constant := 2#00000000000000100#;
   MAC_CAP_SYS_MEM   : constant := 2#00000000000001000#;
   MAC_CAP_USE_NET   : constant := 2#00000000000010000#;
   MAC_CAP_SYS_NET   : constant := 2#00000000000100000#;
   MAC_CAP_SYS_MNT   : constant := 2#00000000001000000#;
   MAC_CAP_SYS_PWR   : constant := 2#00000000010000000#;
   MAC_CAP_PTRACE    : constant := 2#00000000100000000#;
   MAC_CAP_SETUID    : constant := 2#00000001000000000#;
   MAC_CAP_SYS_MAC   : constant := 2#00000010000000000#;
   MAC_CAP_CLOCK     : constant := 2#00000100000000000#;
   MAC_CAP_SIGNALALL : constant := 2#00001000000000000#;
   MAC_CAP_SETGID    : constant := 2#00010000000000000#;
   MAC_CAP_IPC       : constant := 2#00100000000000000#;
   MAC_CAP_SYS_LOG   : constant := 2#01000000000000000#;
   MAC_CAP_SYS_PCI   : constant := 2#10000000000000000#;
   ...
   type NVMM_Caps is record
      Version      : Unsigned_32; --  We are 2 since we add NVMM_VCPU_Stop.
      State_Size   : Unsigned_32;
      Max_Machines : Unsigned_32;
      Max_VCPUs    : Unsigned_32;
      Max_RAM      : Unsigned_64;
   end record;
