--  kernel_main.ads: Main functions of the freestanding kernel.
...
package Kernel_Main is
   --  The main function of the freestanding kernel, this will usually be
   --  called by entrypoint functions from source/arch. The state assumed when
